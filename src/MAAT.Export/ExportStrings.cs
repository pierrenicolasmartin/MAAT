...
public static class ExportStrings
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Fr = new Dictionary<string, string>
    {
        ...
        ["J_AclUnreadable"] = "ACL illisible : les droits de cet élément n'ont pas pu être lus (voir le journal d'audit).",
        ["St_AclUnreadable"] = "ACL illisible",
        ["St_AclUnreadableTip"] = "Les droits de cet élément n'ont pas pu être lus (accès refusé ou erreur) : il est conservé dans l'arbre, sans ACE.",
        ["St_ContentUnreadable"] = "Contenu non listable",
        ["St_ContentUnreadableTip"] = "Le contenu de ce dossier n'a pas pu être listé, ou seulement en partie : sous-éléments potentiellement absents.",
        ["St_DfsLink"] = "Lien DFS",
        ["St_DfsLinkTip"] = "Lien d'espace de noms DFS : son contenu est celui de la cible vers laquelle il redirige.",
        ["St_Cycle"] = "Boucle",
        ["St_CycleTip"] = "Ce dossier réapparaît dans sa propre ascendance : son contenu n'est pas reparcouru.",
        ["St_DepthLimit"] = "Profondeur max.",
        ["St_DepthLimitTip"] = "Profondeur de sécurité atteinte : contenu non parcouru.",
        ["St_NullDacl"] = "DACL nulle",
        ["St_NullDaclTip"] = "Aucune liste de contrôle d'accès : accès total pour tous.",
        ["Csv_AclUnreadable"] = "(ACL illisible)",
        ["Csv_NoAce"] = "(aucune ACE)",
    ...
    private static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>
    {
        ...
        ["J_AclUnreadable"] = "ACL unreadable: this item's permissions could not be read (see the audit log).",
        ["St_AclUnreadable"] = "ACL unreadable",
        ["St_AclUnreadableTip"] = "This item's permissions could not be read (access denied or error): it is kept in the tree, without ACE.",
        ["St_ContentUnreadable"] = "Content not listable",
        ["St_ContentUnreadableTip"] = "This folder's content could not be listed, or only partially: sub-items may be missing.",
        ["St_DfsLink"] = "DFS link",
        ["St_DfsLinkTip"] = "DFS namespace link: its content is that of the target it redirects to.",
        ["St_Cycle"] = "Loop",
        ["St_CycleTip"] = "This folder reappears in its own ancestry: its content is not walked again.",
        ["St_DepthLimit"] = "Max depth",
        ["St_DepthLimitTip"] = "Safety depth reached: content not walked.",
        ["St_NullDacl"] = "Null DACL",
        ["St_NullDaclTip"] = "No access control list: full access for everyone.",
        ["Csv_AclUnreadable"] = "(ACL unreadable)",
        ["Csv_NoAce"] = "(no ACE)",
