...
/// <summary>
/// Emplacement (élément) où une identité possède une ACE directe — table des
/// emplacements de la vue Identités. Une ligne par ACE de l'identité.
/// </summary>
public sealed record IdentityLocationRow(
    string FullPath,
    string Name,
    bool IsFile,
    int AceType,
