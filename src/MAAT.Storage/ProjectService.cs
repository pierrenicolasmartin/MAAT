...
public static class ProjectService
{
    ...
    /// </summary>
    public static void SaveAs(AuditDatabase db, string targetPath, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            // 2) Compression gzip vers le .maat final (copie par blocs, annulable).
